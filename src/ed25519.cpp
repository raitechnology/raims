...
static void expand256_modm( bignum256modm out, const uint8_t *in,
                            size_t len ) noexcept;
static void ge25519_scalarmult_base_niels( ge25519 *r,
                                      const bignum256modm s ) noexcept;
static void ge25519_scalarmult_base_choose_niels( ge25519_niels *t,
                                      const uint8_t  table[ 256 ][ 96 ],
                                      uint32_t pos, signed char b ) noexcept;
static void ge25519_pack( uint8_t r[ 32 ], const ge25519 *p ) noexcept;
static int ge25519_unpack_negative_vartime( ge25519 *r,
                                      const uint8_t p[ 32 ] ) noexcept;
static void ge25519_double_scalarmult_vartime( ge25519 *r, const ge25519 *p1,
                                      const bignum256modm s1,
                                      const bignum256modm s2 ) noexcept;
static void mul256_modm( bignum256modm r, const bignum256modm x,
                         const bignum256modm y ) noexcept;
static void add256_modm( bignum256modm r, const bignum256modm x,
                         const bignum256modm y ) noexcept;
static void contract256_modm( uint8_t out[ 32 ], const bignum256modm in ) noexcept;

struct hash_512bits : public KeyT<hash_512bits, 64> {
  hash_512bits( const uint8_t *k = NULL ) : KeyT( k ) {}
...
static void
ed25519_hram( hash_512bits &hram, const ed25519_signature &RS,
...
ED25519::sign( const void *m, size_t mlen ) noexcept
{
  ...
  ge25519_pack( this->sig, &R );

  /* S = H(R,A,m).. */
  ed25519_hram( hram, this->sig, this->pk, m, mlen );
  ...
  /* S = (r + H(R,A,m)a) mod L */
  contract256_modm( this->sig + 32, S );
}

static int
ed25519_verify( const uint8_t *x, const uint8_t *y, size_t len ) noexcept
{
...
int
ED25519::sign_open( const void *m, size_t mlen ) const noexcept
{
  ge25519       R, A;
  hash_512bits  hash;
  ...
  if ( ( this->sig[ 63 ] & 0xe0 ) != 0 ||
       ! ge25519_unpack_negative_vartime( &A, this->pk ) )
    return -1;

  /* hram = H(R,A,m) */
  ed25519_hram( hash, this->sig, this->pk, m, mlen );
  expand256_modm( hram, hash, 64 );

  /* S */
  expand256_modm( S, this->sig + 32, 32 );
  ...
  return ed25519_verify( this->sig, checkR, 32 ) ? 0 : -1;
}
...
/* out = in */
static void
curve25519_copy( bignum25519 out, const bignum25519 in ) noexcept
{
  out[ 0 ] = in[ 0 ];
  out[ 1 ] = in[ 1 ];
  out[ 2 ] = in[ 2 ];
...
/* out = a + b */
static void
curve25519_add( bignum25519 out, const bignum25519 a, const bignum25519 b ) noexcept
{
  out[ 0 ] = a[ 0 ] + b[ 0 ];
  out[ 1 ] = a[ 1 ] + b[ 1 ];
  out[ 2 ] = a[ 2 ] + b[ 2 ];
...
static void
curve25519_add_reduce( bignum25519 out, const bignum25519 a,
                       const bignum25519 b ) noexcept
{
  uint64_t c;
  out[ 0 ] = a[ 0 ] + b[ 0 ];
...
/* out = a - b */
static void
curve25519_sub( bignum25519 out, const bignum25519 a, const bignum25519 b ) noexcept
{
  out[ 0 ] = a[ 0 ] + twoP0 - b[ 0 ];
...
static void
curve25519_sub_reduce( bignum25519 out, const bignum25519 a,
                       const bignum25519 b ) noexcept
{
  uint64_t c;
  out[ 0 ] = a[ 0 ] + fourP0 - b[ 0 ];
...
/* out = -a */
static void
curve25519_neg( bignum25519 out, const bignum25519 a ) noexcept
{
  uint64_t c;
  out[ 0 ] = twoP0 - a[ 0 ];
  c        = ( out[ 0 ] >> 51 );
...
/* out = a * b */
static void
curve25519_mul( bignum25519 out, const bignum25519 in2, const bignum25519 in ) noexcept
{
  uint128_t t[ 5 ];
...
static void
curve25519_mul_noinline( bignum25519 out, const bignum25519 in2,
                         const bignum25519 in ) noexcept
{
...
/* out = in^(2 * count) */
static void
curve25519_square_times( bignum25519 out, const bignum25519 in, uint64_t count ) noexcept
{
  uint128_t t[ 5 ];
...
static void
curve25519_square( bignum25519 out, const bignum25519 in ) noexcept
{
  uint128_t t[ 5 ];
  uint64_t  r0, r1, r2, r3, r4, c;
  uint64_t  d0, d1, d2, d4, d419;
...
static void
curve25519_expand( bignum25519 out, const uint8_t *in ) noexcept
{
  static const union {
    uint8_t  b[ 2 ];
    uint16_t s;
 ...
 */
static void
curve25519_contract( uint8_t *out, const bignum25519 input ) noexcept
{
  uint64_t t[ 5 ];
  uint64_t f, i;
...
/* if (iswap) swap(a, b) */
static void
curve25519_swap_conditional( bignum25519 a, bignum25519 b, uint64_t iswap ) noexcept
{
...
lt_modm( bignum256modm_element_t a, bignum256modm_element_t b ) noexcept
{
  return ( a - b ) >> 63;
}

static void
reduce256_modm( bignum256modm r ) noexcept
{
  bignum256modm           t;
...
static void
barrett_reduce256_modm( bignum256modm r, const bignum256modm q1,
                        const bignum256modm r1 ) noexcept
{
  bignum256modm           q3, r2;
  uint128_t               c, mul;
...
static void
add256_modm( bignum256modm r, const bignum256modm x, const bignum256modm y ) noexcept
{
...
static void
mul256_modm( bignum256modm r, const bignum256modm x, const bignum256modm y ) noexcept
{
  bignum256modm           q1, r1;
  uint128_t               c, mul;
...
static uint64_t
U8TO64_LE( const uint8_t *p ) noexcept
{
...
static void
expand256_modm( bignum256modm out, const uint8_t *in, size_t len ) noexcept
{
  uint8_t                 work[ 64 ] = { 0 };
...
static void
expand_raw256_modm( bignum256modm out, const uint8_t in[ 32 ] ) noexcept
{
...
static void
U64TO8_LE( uint8_t *p, const uint64_t v ) noexcept
{
  p[ 0 ] = (uint8_t) ( v );
  p[ 1 ] = (uint8_t) ( v >> 8 );
  p[ 2 ] = (uint8_t) ( v >> 16 );
...
static void
contract256_modm( uint8_t out[ 32 ], const bignum256modm in ) noexcept
{
...
static void
contract256_window4_modm( signed char r[ 64 ], const bignum256modm in ) noexcept
{
  char                    carry;
  signed char *           quads = r;
...
static void
sub256_modm_batch( bignum256modm out, const bignum256modm a,
                   const bignum256modm b, size_t limbsize ) noexcept
{
  size_t                  i     = 0;
...
/* is a < b */
static int
lt256_modm_batch( const bignum256modm a, const bignum256modm b,
                  size_t limbsize ) noexcept
{
  size_t                  i = 0;
...
/* is a <= b */
static int
lte256_modm_batch( const bignum256modm a, const bignum256modm b,
                   size_t limbsize ) noexcept
{
  size_t                  i = 0;
  bignum256modm_element_t t, carry = 0;
...
/* is a == 0 */
static int
iszero256_modm_batch( const bignum256modm a ) noexcept
{
  size_t i;
  for ( i = 0; i < 5; i++ )
    if ( a[ i ] )
...
/* is a == 1 */
static int
isone256_modm_batch( const bignum256modm a ) noexcept
{
  size_t i;
  for ( i = 0; i < 5; i++ )
    if ( a[ i ] != ( ( i ) ? 0 : 1 ) )
...
static int
isatmost128bits256_modm_batch( const bignum256modm a ) noexcept
{
...
#endif
static void
ge25519_p1p1_to_partial( ge25519 *r, const ge25519_p1p1 *p ) noexcept
{
...
static void
ge25519_p1p1_to_full( ge25519 *r, const ge25519_p1p1 *p ) noexcept
{
  curve25519_mul( r->x, p->x, p->t );
  curve25519_mul( r->y, p->y, p->z );
  curve25519_mul( r->z, p->z, p->t );
...
static void
ge25519_full_to_pniels( ge25519_pniels *p, const ge25519 *r ) noexcept
{
...
#if 0
static void
ge25519_add_p1p1( ge25519_p1p1 *r, const ge25519 *p, const ge25519 *q ) noexcept
{
...
#endif
static void
ge25519_double_p1p1( ge25519_p1p1 *r, const ge25519 *p ) noexcept
{
  bignum25519 a, b, c;
...
static void
ge25519_nielsadd2_p1p1( ge25519_p1p1 *r, const ge25519 *p,
                        const ge25519_niels *q, uint8_t signbit ) noexcept
{
...
static void
ge25519_pnielsadd_p1p1( ge25519_p1p1 *r, const ge25519 *p,
                        const ge25519_pniels *q, uint8_t signbit ) noexcept
{
  const bignum25519 *qb = (const bignum25519 *) q;
  bignum25519 *      rb = (bignum25519 *) r;
  bignum25519        a, b, c;
...
static void
ge25519_double_partial( ge25519 *r, const ge25519 *p ) noexcept
{
  ge25519_p1p1 t;
...
static void
ge25519_double( ge25519 *r, const ge25519 *p ) noexcept
{
  ge25519_p1p1 t;
  ge25519_double_p1p1( &t, p );
...
#if 0
static void
ge25519_add( ge25519 *r, const ge25519 *p, const ge25519 *q ) noexcept
{
  ge25519_p1p1 t;
...
#endif
static void
ge25519_nielsadd2( ge25519 *r, const ge25519_niels *q ) noexcept
{
...
static void
ge25519_pnielsadd( ge25519_pniels *r, const ge25519 *p,
                   const ge25519_pniels *q ) noexcept
{
 ...
 */
static void
curve25519_pow_two5mtwo0_two250mtwo0( bignum25519 b ) noexcept
{
  bignum25519 t0, c;
 ...
 */
static void
curve25519_recip( bignum25519 out, const bignum25519 z ) noexcept
{
  bignum25519 a, t0, b;
 ...
 */
static void
curve25519_pow_two252m3( bignum25519 two252m3, const bignum25519 z ) noexcept
{
  bignum25519 b, c, t0;
...
static void
ge25519_pack( uint8_t r[ 32 ], const ge25519 *p ) noexcept
{
...
static int
ge25519_unpack_negative_vartime( ge25519 *r, const uint8_t p[ 32 ] ) noexcept
{
...
static void
ge25519_double_scalarmult_vartime( ge25519 *r, const ge25519 *p1,
                                   const bignum256modm s1,
                                   const bignum256modm s2 ) noexcept
{
...
static uint32_t
ge25519_windowb_equal( uint32_t b, uint32_t c ) noexcept
{
  return ( ( b ^ c ) - 1 ) >> 31;
}

static void
ge25519_scalarmult_base_choose_niels( ge25519_niels *t,
                                      const uint8_t  table[ 256 ][ 96 ],
                                      uint32_t pos, signed char b ) noexcept
{
  bignum25519 neg;
  uint32_t    sign = ( uint32_t )( (uint8_t) b >> 7 );
...
void
ED25519::scalarmult_basepoint( ec25519_key &pk, const ec25519_key &e ) noexcept
{
  ec25519_key    ec;
  bignum256modm  s;
  bignum25519    yplusz, zminusy;
  ge25519        p;
  size_t         i;
...
static void
ge25519_scalarmult_base_niels( ge25519 *           r,
                               const bignum256modm s ) noexcept
{
  signed char   b[ 64 ];
  uint32_t      i;
